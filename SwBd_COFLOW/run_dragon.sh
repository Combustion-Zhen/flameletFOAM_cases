...
#SBATCH -N 5
#SBATCH -t 1-00:00:00
#SBATCH -J SwBd_COFLOW
#SBATCH -e job%J.err
#SBATCH -o job%J.out
##SBATCH --constraint=intel
#SBATCH --constraint=[cpu_intel_e5_2680_v2]

OMP_NUM_THREADS=1

#canteraToFoam
#
#sed "s/@NUMSUBDOM@/100/g" \
...
#do
#    cd $folder
#    cp /home/luz0a/OpenFOAM/OpenFOAM_py/SwB/inlet/inlet_time_ext.py .
#    cp /home/luz0a/OpenFOAM/OpenFOAM_py/SwB/inlet/inlet_time_jump.py .
...
#    -e "s/@DELTAT@/1e-6/g" -e  "s/@WRITEINTERVAL@/0.05/g" \
#    -e "s/@WRITEFORMAT@/binary/g" \
#    -e "s/@ENABLED@/true/g" \
#    -e "s/@RESTART@/true/g" -e "s/@RESTARTOUT@/false/g" \
#    system/controlDict_template > system/controlDict
